...
func NewRadarr(baseURL, apiKey string) *Radarr {
	return &Radarr{rest: newREST(baseURL, apiKey)}
}

// List returns every movie Radarr tracks.
func (r *Radarr) List(ctx context.Context) ([]Item, error) {
...
// tracks the movie.
func (r *Radarr) Add(ctx context.Context, tmdbID int, opts AddOptions) (*Item, error) {
...
func (r *Radarr) QualityProfiles(ctx context.Context) ([]Profile, error) {
...
func (r *Radarr) Ping(ctx context.Context) (string, error) {
