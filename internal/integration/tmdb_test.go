...
func TestSearchMulti(t *testing.T) {
	...
	want := []Result{
		{TMDBID: 1233413, Type: store.Movie, Title: "Sinners", Year: 2025, PosterPath: "/a.jpg", Overview: "Twins", Popularity: 412.5},
		{TMDBID: 95396, Type: store.TV, Title: "Severance", Year: 2022, PosterPath: "/b.jpg", Overview: "Work", Popularity: 88.1},
		{TMDBID: 777, Type: store.Movie, Title: "Unreleased"},
	}
