...
func TestParseURL(t *testing.T) {
	tests := []struct {
		...
		{"tmdb movie with slug", "https://www.themoviedb.org/movie/1233413-sinners", Ref{TMDBID: 1233413, Type: store.Movie}, true},
		{"tmdb tv", "https://themoviedb.org/tv/95396", Ref{TMDBID: 95396, Type: store.TV}, true},
		{"tmdb with query", "https://www.themoviedb.org/movie/693134?language=en", Ref{TMDBID: 693134, Type: store.Movie}, true},
...
func TestScrapeExtractsTMDBLinkAndTitle(t *testing.T) {
	...
	if got.TMDBID != 1233413 || got.Type != store.Movie {
